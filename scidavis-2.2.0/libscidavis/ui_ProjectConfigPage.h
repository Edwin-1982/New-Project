...
public:
    ...
    void setupUi(QWidget *ProjectConfigPage)
    {
        if (ProjectConfigPage->objectName().isEmpty())
            ProjectConfigPage->setObjectName(QString::fromUtf8("ProjectConfigPage"));
        ...
        default_subwindow_visibility_label->setObjectName(QString::fromUtf8("default_subwindow_visibility_label"));
        ...
        default_subwindow_visibility_combobox->addItem(QString());
        default_subwindow_visibility_combobox->addItem(QString());
        default_subwindow_visibility_combobox->setObjectName(QString::fromUtf8("default_subwindow_visibility_combobox"));
